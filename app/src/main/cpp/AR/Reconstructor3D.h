...
public:
    typedef struct ReconstructParameters
    {
        ...
        int minCountFrames;
        int maxCountFrames;
        TVectord startPointOfReconstructRegion;
...
protected:
    ...
    MapInitializer _homographyInitializer;
    OpticalFlow _opticalFlow;
    std::vector<Image<Point2>> _diffPyramid;
    ...
    void _createCurrentReconstructFrame(Map::KeyFrame& recordFrame);
    void _solveCurrentRecordFrame(Map::KeyFrame& recordFrame);
